          ...
          {blogs.map((blog) => {
            ...
            return (
              <div
                ...
                className="cursor-pointer bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-5 hover:shadow-md transition"
              >
                ...
                <h3 className="text-base font-bold text-gray-800 dark:text-gray-100 mb-2 leading-snug line-clamp-2">
                  {blog.title}
                </h3>
