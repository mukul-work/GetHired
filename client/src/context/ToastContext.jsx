...
const STYLES = {
  success: { icon: "text-emerald-600", bar: "bg-emerald-500", label: "text-emerald-700" },
  error:   { icon: "text-red-500",     bar: "bg-red-500",     label: "text-red-600"     },
  warning: { icon: "text-amber-500",   bar: "bg-amber-400",   label: "text-amber-600"   },
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          {title && (
            <p className={`text-sm font-semibold leading-tight ${s.label}`}>{title}</p>
          )}
          {message && (
